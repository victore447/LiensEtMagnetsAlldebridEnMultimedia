...
"Saisir le nom du films).☝️ Écrire le nom du film et son année de création (XXX (2023) puis ok (**[Infos extraites dur Themoviedb.org](https://www.themoviedb.org/?language=frlorsque)** ).Voir 📸 joints.
- Une autre fenêtre s'ouvre ensuite pour demander si il faut ignorer ou pas des informations existant localement.
